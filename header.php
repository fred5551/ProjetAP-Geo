        ...
        <li class="nav-item dropdown">
          ...
          <?php
              ...
              foreach ($continents as $continent) {
                  echo '<a class="dropdown-item" href="index2.php?continent=' . urlencode($continent->Continent) . '">' . $continent->Continent . '</a>';
              }
              ?>
          </div>
        </li>
        <li class="nav-item dropdown">
          ...
          <?php
              ...
              foreach ($lesPays as $pays) {
                  echo '<a class="dropdown-item" href="detailsPays.php?id='. urlencode($pays->id) . '">' . $pays->Name . '</a>';
              }
              ?>
          </div>
        </li>
